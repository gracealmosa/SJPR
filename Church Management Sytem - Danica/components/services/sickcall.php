<?php
  include('components/head.php');
    function sickCall($sick_call,$priest_info){ ?>
    <head>
        <style>
            .btn-cool-blues{
                background: #2193b0;
...
.sb-search-input {
  ...
  <body><div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sick /</span> Call</h4>
              <!-- Bootstrap modals -->
              <div class="card mb-4">
                <div class="card-body">
                    <!-- Default Modal -->
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Add New Sick Call</h5>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="col mb-3">
                                    <label for="nameBasic" class="form-label">Requested by</label>
                                    <input type="text" id="nameBasic" class="form-control" name="requestedby" placeholder="Enter Requested by">
                                  </div>
                                  <div class="row g-2">
                                  <div class="col mb-0">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="sumbit" class="btn btn-primary" name="add_sickcall">Save changes</button>
                              </div>
                              </form>
                            </div>
                          </div>
                  ...
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="background-color: #1589FF; color: #ffffff;">Requested by</th>
                    ...
                    <?php
                      if ($sick_call) {
                        foreach($sick_call as $sickcall){
                          echo "
                          <tr>
                            <td>$sickcall->firstname   $sickcall->lastname</td>
                            <td>$sickcall->parishioner_name</td>
                            <td>$sickcall->address</td>
                            <td>$sickcall->requestedby</td>
                            <td>$sickcall->date</td>
                            <td>
                            <button type='button' class='btn btn-secondary'>
                            <i class='bi bi-check-circle-fill text-light'></i> Update
                            </button>
                            <button type='submit' class='btn btn-danger delete_sick_id'  data-bs-toggle='modal' data-bs-target='#deletesickModal".$sickcall->sickcall_id."' name='$sickcall->sickcall_id' >
                          ...
                          <div class='modal fade' id='deletesickModal".$sickcall->sickcall_id."' tabindex='-1' aria-hidden='true'>
                          <form method='POST'>
                            <div class='modal-dialog' role='document'>
                              <div class='modal-content'>
                                <div class='modal-header'>
                                ...
                                <div class='modal-footer'>
                                  ...
                                  <input type='hidden' name='sickcall_id' value='".$sickcall->sickcall_id."'/>
                                  <button type='submit' class='btn btn-danger' name='deletesickcall'>Delete</button>
                                </div>
                                </form>
                              </div>
                            </div>
