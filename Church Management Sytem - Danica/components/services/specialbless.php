<?php
  include('components/head.php');
    function specialBless($special_bless,$priest_info){ ?>
    <head>
        <style>
            .btn-cool-blues{
                background: #2193b0;
...
.sb-search-input {
  ...
  <body><div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Special /</span> Bless</h4>
              <!-- Bootstrap modals -->
              <div class="card mb-4">
                <div class="card-body">
                    <!-- Default Modal -->
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Add New Special Bless</h5>
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="sumbit" class="btn btn-primary" name="add_specialbless">Save changes</button>
                              </div>
                              </form>
                            </div>
                          </div>
  ...
  <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  ...
                  <table class="table table-striped">
                    ...
                    <?php
                      if ($special_bless) {
                        foreach($special_bless as $specialbless){
                          echo "
                          <tr>
                            <td>$specialbless->firstname   $specialbless->lastname</td>
                            <td>$specialbless->parishioner_name</td>
                            <td>$specialbless->address</td>
                            <td>$specialbless->contact_no</td>
                            <td>$specialbless->date</td>
                            <td>
                            <button type='button' class='btn btn-secondary'>
                            <i class='bi bi-check-circle-fill text-light'></i> Update
                            </button>
                            <button type='submit' class='btn btn-danger delete_sick_id'  data-bs-toggle='modal' data-bs-target='#deletesickModal".$specialbless->specialbless_id."' name='$specialbless->specialbless_id' >
                          ...
                          <div class='modal fade' id='deletesickModal".$specialbless->specialbless_id."' tabindex='-1' aria-hidden='true'>
                          <form method='POST'>
                            <div class='modal-dialog' role='document'>
                              <div class='modal-content'>
                                <div class='modal-header'>
                                ...
                                <div class='modal-footer'>
                                  ...
                                  <input type='hidden' name='sbless_id' value='".$specialbless->specialbless_id."'/>
                                  <button type='submit' class='btn btn-danger' name='deletebless'>Delete</button>
                                </div>
                                </form>
                              </div>
                            </div>
